...
// Se especifica que la carpeta "public" se utilizará para alojar recursos estáticos
...
// Se define la respuesta que se enviará al cliente cuando se envíe un formulario para agregar un estudiante
app.post('/addStudent', (req, res) => {
    // Se renderiza la plantilla "displayData" y se envían los datos recibidos del formulario
